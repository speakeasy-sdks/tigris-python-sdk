...
class GetUserMetadataRequest:
    ...
    value: Optional[GetUserMetadataRequestValue] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('value'), 'exclude': lambda f: f is None }})
