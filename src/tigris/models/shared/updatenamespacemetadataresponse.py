...
class UpdateNamespaceMetadataResponse:
    ...
    value: Optional[UpdateNamespaceMetadataResponseValue] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('value'), 'exclude': lambda f: f is None }})
