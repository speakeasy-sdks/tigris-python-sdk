...
import dataclasses
from .docstatus import DocStatus
...
class UpdateDocumentResponse:
    status: Optional[List[DocStatus]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('status'), 'exclude': lambda f: f is None }})
