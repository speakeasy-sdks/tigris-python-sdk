...
class ReadRequest:
    ...
    fields: Optional[ReadRequestFields] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('fields'), 'exclude': lambda f: f is None }})
    r"""To read specific fields from a document. Default is all."""
