...
class UpdateUserMetadataResponseValue:
    pass
...
class UpdateUserMetadataResponse:
    r"""Update of user metadata response"""
    ...
    value: Optional[UpdateUserMetadataResponseValue] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('value'), 'exclude': lambda f: f is None }})
