...
class Cache:
    ...
    def create(self, request: operations.CacheCreateCacheRequest) -> operations.CacheCreateCacheResponse:
        ...
        res = operations.CacheCreateCacheResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def delete(self, request: operations.CacheDeleteCacheRequest) -> operations.CacheDeleteCacheResponse:
        ...
        res = operations.CacheDeleteCacheResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def delete_keys(self, request: operations.CacheDelRequest) -> operations.CacheDelResponse:
        ...
        res = operations.CacheDelResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get_key(self, request: operations.CacheGetRequest) -> operations.CacheGetResponse:
        ...
        res = operations.CacheGetResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get_set_key(self, request: operations.CacheGetSetRequest) -> operations.CacheGetSetResponse:
        ...
        res = operations.CacheGetSetResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def list(self, request: operations.CacheListCachesRequest) -> operations.CacheListCachesResponse:
        ...
        res = operations.CacheListCachesResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def list_keys(self, request: operations.CacheKeysRequest) -> operations.CacheKeysResponse:
        ...
        query_params = { **utils.get_query_params(operations.CacheKeysRequest, request), **query_params }
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = operations.CacheKeysResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def set_key(self, request: operations.CacheSetRequest) -> operations.CacheSetResponse:
        ...
        res = operations.CacheSetResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
