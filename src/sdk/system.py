...
class System:
    ...
    def query_quota_limits(self, request: operations.ObservabilityQuotaLimitsRequest) -> operations.ObservabilityQuotaLimitsResponse:
    ...
    def query_time_series_metrics(self, request: operations.ObservabilityQueryTimeSeriesMetricsRequest) -> operations.ObservabilityQueryTimeSeriesMetricsResponse:
