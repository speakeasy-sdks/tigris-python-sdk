...
class SearchDeleteRequest:
    path_params: SearchDeletePathParams = dataclasses.field()
    request: shared_deletedocumentrequest.DeleteDocumentRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
