...
class TigrisRotateAppKeySecretPathParams:
    project: str = dataclasses.field(metadata={'path_param': { 'field_name': 'project', 'style': 'simple', 'explode': False }})
    

@dataclasses.dataclass
class TigrisRotateAppKeySecretRequest:
    path_params: TigrisRotateAppKeySecretPathParams = dataclasses.field()
    request: shared_rotateappkeyrequest.RotateAppKeyRequest = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
