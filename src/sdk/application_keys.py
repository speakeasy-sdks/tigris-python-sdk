...
class ApplicationKeys:
    ...
    def tigris_create_app_key(self, request: operations.TigrisCreateAppKeyRequest) -> operations.TigrisCreateAppKeyResponse:
        ...
        url = utils.generate_url(base_url, '/v1/projects/{project}/apps/keys/create', request.path_params)
    ...
    def tigris_delete_app_key(self, request: operations.TigrisDeleteAppKeyRequest) -> operations.TigrisDeleteAppKeyResponse:
        ...
        url = utils.generate_url(base_url, '/v1/projects/{project}/apps/keys/delete', request.path_params)
    ...
    def tigris_list_app_keys(self, request: operations.TigrisListAppKeysRequest) -> operations.TigrisListAppKeysResponse:
        ...
        url = utils.generate_url(base_url, '/v1/projects/{project}/apps/keys', request.path_params)
    ...
    def tigris_rotate_app_key_secret(self, request: operations.TigrisRotateAppKeySecretRequest) -> operations.TigrisRotateAppKeySecretResponse:
        ...
        url = utils.generate_url(base_url, '/v1/projects/{project}/apps/keys/rotate', request.path_params)
    ...
    def tigris_update_app_key(self, request: operations.TigrisUpdateAppKeyRequest) -> operations.TigrisUpdateAppKeyResponse:
        ...
        url = utils.generate_url(base_url, '/v1/projects/{project}/apps/keys/update', request.path_params)
